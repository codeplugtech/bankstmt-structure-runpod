...
def handler(job):
    ...
    page_num = 1 if user_id is None else job_input.get('page_num', 1)
    ...
    for page_number in range(pages):
        ...
        for table_number, crop_image in enumerate(crop_images):
            ...
            table_structures, cells, confidence_score = table_extractor.convert_structure(words, crop_image, structure_result)
